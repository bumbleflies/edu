...
export const ui: Record<Lang, UiStrings> = {
  en: {
    ...
    footerAboutPrefix: "Hands-on STEM programming and robotics courses for kids 8–14,",
  ...
  de: {
    ...
    footerAboutPrefix: "Praktische MINT-Programmier- und Robotik-Kurse für Kinder von 8–14 Jahren,",
