...
describe('DE flyer page', () => {
  ...
  it('keeps the layout wrapper, its title and the language toggle', () => {
    expect(source).toContain('<Layout lang="de" altHref="/en/flyer"');
  ...
  it('renders the shared one-page ParentFlyer component in German only', () => {
    expect(source).toContain('<ParentFlyer lang="de"');
